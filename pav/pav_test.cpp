...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) { 
  ...
  mexPrintf("calling pav\n");
  pav_float(a, 14, a_out);
  print_const_size_array(a_out, 14);


  //mexPrintf("checking vminus:\n");
  //print_const_size_array(vminus(a,lmargins), 14);

  mexPrintf("expected:\n");
  mexPrintf("1.000000 7.800000 7.800000 7.800000 7.800000 7.800000 9.375000 " 
